    ...
    <RegisterContainer>
      <Card multipleInputs headerChildren={ <img src={TaskyLogoDark} alt={'Tasky logo'} className='logo' />} defaultColor>
        <form onSubmit={ handleSubmit }>
          ...
          <>
            <InputsContainer>
              <Input touched={ touched.email } error={ errors.email } name='email' onChange={ handleChange } value={ values.email } onBlur={ handleBlur } type={'email'} id="email" inputLabel={'Correo electrónico *'} placeholder={'correo electrónico'}/>
              <Input touched={ touched.username } error={ errors.username } name='username' onChange={ handleChange } value={ values.username } onBlur={ handleBlur } type={'text'} id="username" inputLabel={'Nombre de usuario *'} placeholder={'nombre de usuario'} />
            </InputsContainer>
            <InputsContainer>
              <Input touched={ touched.fullname } error={ errors.fullname } name='fullname' onChange={ handleChange } value={ values.fullname } onBlur={ handleBlur } type={'text'} id="fullname" inputLabel={'Nombre y Apellido *'} placeholder={'nombre y apellido'} />
              <Input touched={ touched.password } error={ errors.password } name='password' onChange={ handleChange } value={ values.password } onBlur={ handleBlur } type={'password'} id="password" icon={<Icon as={icons.eye} white />} inputLabel={'Contraseña *'} maxLength={40} placeholder={'contraseña'} />
            </InputsContainer>
            <InputsContainer>
              <Input touched={ touched.repeatPassword } error={ errors.repeatPassword } name='repeatPassword' onChange={ handleChange } value={ values.repeatPassword } onBlur={ handleBlur } type={'password'} id="repeatPassword" icon={<Icon as={icons.eye} white />} inputLabel={'Repetir contraseña *'} maxLength={40} placeholder={'repetir contraseña'} />
            </InputsContainer>
            <ButtonsContainer>
          ...
          <>
            <InputsContainer>
              <Input touched={ touched.phone } error={ errors.phone } name='phone' onChange={ handleChange } value={ values.phone } onBlur={ handleBlur } type={'tel'} id="phone" inputLabel={'Teléfono *'} placeholder={'teléfono'} />
            ...
            <InputsContainer>
              <Input touched={ touched.teamId } error={ errors.teamId } name='teamId' onChange={ handleChange } value={ values.teamId } onBlur={ handleBlur } type={'teamId'} id="teamId" icon={<Icon as={icons.eye} white />} inputLabel={'ID del equipo (nuevo o existente) *'} maxLength={40} placeholder={'ID del equipo'} />
              <Input touched={ touched.teamPassword } error={ errors.teamPassword } name='teamPassword' onChange={ handleChange } value={ values.teamPassword } onBlur={ handleBlur } type={'password'} id="teamPassword" icon={<Icon as={icons.eye} white />} inputLabel={'Contraseña del equipo *'} maxLength={40} placeholder={'contraseña del equipo'} />
            </InputsContainer>
