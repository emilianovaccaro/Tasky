  ...
  return(
    <SidebarContainer openSidebar={openSidebar}>
      ...
      <ProfileContainer openSidebar={openSidebar}>
        {loading ? <Spinner /> : <Profile imagePath={user.profilePhoto} imageSize={32} labelText={user.fullname} subLabelText={user.isAdmin ? `Administrador de ${user.teamId}` : `Miembro de ${user.teamId}`}/>}
      </ProfileContainer>
    </SidebarContainer>
  )
}
